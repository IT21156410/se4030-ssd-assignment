...
<body>
    ...
    $sql = "SELECT COUNT(*) as total_comments FROM comments_events WHERE Event_ID = ?";
    ...
    $stmt = $conn->prepare("SELECT * FROM comments_events WHERE Event_ID = ? ORDER BY COMMENT_ID DESC LIMIT ?,?;");
                        ...
                        <ul class="pagination">
                            ...
                            <li class="page-item <?php if ($page_no <= 1) {
                                ...
                                <a class="page-link" href="<?php if ($page_no <= 1) {
                                                                ...
                                                                echo 'single-post.php?post_id=' . urlencode($post_identification) . '&page_no=' . urlencode($page_no - 1);
                                                            } ?>">
                                    <
                                        </a>
