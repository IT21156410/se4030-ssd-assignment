...
if (isset($_POST['posting'])) {
    ...
    $sql_query = "INSERT INTO videos (User_ID, Likes, Video_Path, Caption, HashTags, Date_Upload, Thumbnail_Path)VALUES (?, ?, ?,?, ?, ?, ?)";

    $stmt = $conn->prepare($sql_query);
    $stmt->bind_param("iisssss", $ID, $likes, $file_complete, $caption, $hashtags, $date, $thumbnail_name_complete);
