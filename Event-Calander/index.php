...
<html lang="en">
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ss", $nextday, $nextYear);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    $sql = "SELECT * FROM special_events WHERE Event_Date BETWEEN ? AND ?";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ss", $todayIs, $nextYear);
    $stmt->execute();
    $result = $stmt->get_result();
                ...
                <div class="col-md">
                    <div class="specialEvents">
                        <div class="text-center">
                            <img class="specialEventsImage" src="images/dec1.jpg" alt="Italian Trulia"
