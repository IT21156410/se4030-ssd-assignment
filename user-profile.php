                    ...
                    <div class="social">
                        ...
                        <ul>
                            <li><i class="fas fa-envelope"></i>
                                <a href="<?php echo $array_user['EMAIL'] ?>" id="email_id">Email</a>
                            </li>

                            <li><i class="fab fa-facebook-square"></i>
                                <a href="<?php echo $array_user['FACEBOOK'] ?>" id="email_id">Facebook</a>
                            </li>

                            <li><i class="fab fa-whatsapp-square"></i>
                                <a href="<?php echo $array_user['WHATSAPP'] ?>" id="email_id">Whatsapp</a>
                            </li>
