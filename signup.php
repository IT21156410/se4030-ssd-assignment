                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form method="post" id="signup_form" action="signup-action.php">
                                    ...
                                    <div class="form-floating mt-2 text-muted h6" style="font-size:small;">
                                        <input type="password" name="retype_password" class="form-control form-control-lg0" id="retype_pass" placeholder="Retype Password"
                                               onchange="verify_form();">
                                    ...
                                    <p class="mb-4 pb-lg-2" style="color: #19afd4;">
                                        Have an account? <a href="assets/pages/signup.php" style="color: #2696ca;">SignIn</a>
                                    </p>
                                </form>
                            </div>
                        </div>
