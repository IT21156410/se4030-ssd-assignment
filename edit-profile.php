                ...
                <div class="card-body">
                    ...
                    <div class="account-settings">
                        ...
                        <div class="about">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i
                                        class="icon fas fa-user-edit"></i>Change Profile Pic
                            </button>
                            <br>

                            <button type="button" class="btn btn-outline-primary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#passchange"><i
                                        class="fas fa-shield-alt"></i>Password & Security
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="little bit about you"
                                          name="bio"><?php echo $_SESSION['bio']; ?></textarea>
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="whatsapp" placeholder="Enter WhatsApp Link" name="wapp"
