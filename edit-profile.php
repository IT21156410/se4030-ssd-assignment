                            ...
                            <div class="account-settings">
                                ...
                                <div class="user-profile-edit">
                                    ...
                                    <div class="user-avatar">
                                        ...
                                        <img src="<?php echo htmlspecialchars("assets/images/profiles/" . $_SESSION['img_path'], ENT_QUOTES, 'UTF-8'); ?>" alt="profile-avatar">

                                    </div>

                                    <h5 class="user-name"><?php echo htmlspecialchars($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></h5>

                                    <h6 class="user-email"><?php echo htmlspecialchars($_SESSION['fullname'], ENT_QUOTES, 'UTF-8'); ?></h6>
                                ...
                                <div class="about">
                                    ...
                                    <p><?php echo htmlspecialchars($_SESSION['bio'], ENT_QUOTES, 'UTF-8'); ?></p>

                                    <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="icon fas fa-user-edit"></i>Change Profile Pic</button>
                                    <br>
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fullName" name="full_name" placeholder="Enter full name/Organization Name" value="<?php echo htmlspecialchars($_SESSION['fullname'], ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="user_name" name="user_name" placeholder="Enter User Name" value="<?php echo htmlspecialchars($_SESSION['user_name'], ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="little bit about you" name="bio"><?php echo htmlspecialchars($_SESSION['bio'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter email address" value="<?php echo htmlspecialchars($_SESSION['email'], ENT_QUOTES, 'UTF-8'); ?>">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="whatsapp" placeholder="Enter WhatsApp Link" name="wapp" value="<?php echo htmlspecialchars($_SESSION['whatsapp'], ENT_QUOTES, 'UTF-8'); ?>">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="facebook" placeholder="Enter Facebook Link" name="fbook" value="<?php echo htmlspecialchars($_SESSION['facebook'], ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="text-right">
                                                ...
                                                ?>
                                                <br>
                                                <button type="submit" id="cancel" name="submits" class="btn btn-secondary">Cancel</button>
