        ...
        <section class="main">
            ...
            <div class="wrapper">
                ...
                <div class="left-col" id="left-col">
                    ...
                    include('get-latest-events-action.php');
                        ...
                        <div class="post">
                            ...
                            <div class="post-content">
                                ...
                                <div class="reactions-wrapper">
                                    ...
                                    <a href="single-event.php?post_id=<?php echo $post["Event_ID"] ?>" style="color: #22262A;">
                ...
                <div class="right-col">
                    ...
                    <div class="card" style="width: 90%; border-radius: 10px; background: #F5F5F5; border: 1px solid #fdfdfd;">
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                <button class="fallow-btn" style="font-size: 12px;">
                                    <a href="single-event.php?post_id=<?php echo $Event_ID; ?>">Read More</a>
                                </button>
                            </form>
                        </div>
