...
<body>
    ...
    $sql = "SELECT COUNT(*) as total_comments FROM comments_vid WHERE VIDEO_ID = ?";
    ...
    $Query = "SELECT * FROM comments_vid WHERE VIDEO_ID = ? ORDER BY COMMENT_ID DESC LIMIT ?, ?;";
            ...
            <div class="left-col">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <i class="fa-solid fa-pen-to-square" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-bs-whatever="@mdo"></i>
                                    <a href="" style="color: black; text-decoration: none;">Edit Post</a>
                                    <br><br>

                                    <i class="fa-solid fa-trash" data-bs-toggle="modal" data-bs-target="#delete_model" data-bs-whatever="@mdo"></i>
                                    <a href="" style="color: black; text-decoration: none;">Delete Post</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <i class="fa-solid fa-pen-to-square" data-bs-toggle="modal" data-bs-target="#edit-comment" data-bs-whatever="@mdo"></i>
                                    <a href="" style="color: black; text-decoration: none;">Edit Comment</a>
                                    <br><br>

                                    <i class="fa-solid fa-trash" data-bs-toggle="modal" data-bs-target="#delete_comment" data-bs-whatever="@mdo"></i>
                        ...
                        <ul class="pagination">
                            ...
                            <li class="page-item <?php if ($page_no <= 1) {
                                ...
                                <a class="page-link" href="<?php if ($page_no <= 1) {
                                                                ...
                                                                // Sanitize post_id
                                                                $safe_post_id = htmlspecialchars($post_identification, ENT_QUOTES, 'UTF-8');
                                                                // Sanitize and ensure page_no is an integer
                                                                $safe_page_no = intval($page_no - 1);
                                                                echo 'single-post.php?post_id=' . $safe_post_id . '&page_no=' . $safe_page_no;
                                                            } ?>">
                                    &lt;
                                </a>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="edit-post-video-action.php">
                                    <div class="mb-3">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form action="delete-video-action.php" method="post">
                                    <input type="hidden" name="post_id" value="<?php echo $post['Video_ID']; ?>">
                ...
                <div class="modal fade" id="edit-comment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                <form method="post" action="edit-comment-video-action.php">
                                    <div class="mb-3">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form action="delete-video-comment-action.php" method="post">
            ...
            <div class="right-col">
                ...
                <div class="style-wrapper mt-2" style="background: #F5F5F5;">
                    ...
                    <div class="suggestion_card">
                        ...
                        <a href="logout.php">
                            <button class="fallow-btn" style="margin-left: 30px; font-size: small">LOG OUT</button>
                        </a>
